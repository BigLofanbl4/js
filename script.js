...
// let labels = [];
// repeat(5, (i) => labels.push(`Block ${i + 1}`));
// console.log(labels);
...
// function noisy(f) {
//   return (...args) => {
//     console.log("Call for ", args);
//     let result = f(...args);
//     console.log("Call for ", args, "returns", result);
//     return result;
//   }
// }
...
// console.log(rtlScripts.map(elem => elem.name));
...
//   if (biggest == null || characterCount(script) > characterCount(biggest)) {
//     biggest = script;
//   }
// }
...
// console.log(smiles.charCodeAt(0));
// console.log(smiles.codePointAt(0))
